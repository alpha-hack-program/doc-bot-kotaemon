...
print(f"LOCAL_OPENAI_API_BASE: {config("LOCAL_OPENAI_API_BASE", default="")}")
...
print(f"LOCAL_OPENAI_EMBEDDINGS_API_BASE: {config("LOCAL_OPENAI_EMBEDDINGS_API_BASE", default="")}")
